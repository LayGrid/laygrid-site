...
<div className="bg-black text-white min-h-screen">
      ...
      {/* HERO: Vollbild mit Hintergrundbild */}
...
<div
        ...
        {/* dunkler Verlauf-Overlay, damit Text gut lesbar ist */}
...
<Link
                ...
                className="inline-flex items-center justify-center rounded-lg px-6 py-3 text-sm font-medium bg-[#FF6037] text-[#F5F4ED] hover:bg-[#733635] transition-colors"
>
...
<Link
                ...
                className="inline-flex items-center justify-center rounded-lg px-6 py-3 text-sm font-medium border border-white/40 text-[#F5F4ED] hover:bg-white/10 transition-colors"
>
